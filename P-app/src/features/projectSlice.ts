...
export const addProject = createAsyncThunk<
  ...
  Project,
  { rejectValue: string }
>("projects/addProject", async (newProject, { rejectWithValue }) => {
...
export const updateProject = createAsyncThunk<
  ...
  Project,
  { rejectValue: string }
>("projects/updateProject", async (updatedProject, { rejectWithValue }) => {
  try {
    console.log("Updating project:", updatedProject);
    const response = await axios.put<Project>(
      `http://127.0.0.1:5000/api/projects/${updatedProject.id}`,
      updatedProject
    );
